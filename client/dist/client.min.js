   ...
   */
  {
    (function() {
      ...
      function useMutableSource(hook, source2, getSnapshot, subscribe) {
        ...
        if (!objectIs(prevGetSnapshot, getSnapshot) || !objectIs(prevSource, source2) || !objectIs(prevSubscribe, subscribe)) {
          var newQueue = {
            pending: null,
            dispatch: null,
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  const useTranslation = () => {
    const t = react.exports.useCallback((key) => {
  ...
  var _jsxFileName$5 = "/home/jarancibia/git/todo-boilerplate/client/components/ConfirmationDialog.jsx";
  const ConfirmationDialog = ({
    ...
    }, t("confirmAction")), /* @__PURE__ */ React.createElement("div", {
  ...
  var _jsxFileName$4 = "/home/jarancibia/git/todo-boilerplate/client/components/TodoItem.jsx";
  const TodoItem = ({
    todo,
    onEdit,
    onDelete
    ...
    const [isConfirmOpen, setIsConfirmOpen] = react.exports.useState(false);
    ...
    return /* @__PURE__ */ React.createElement("li", {
      ...
      className: "text-gray-800 break-all mr-4",
      __self: void 0,
      __source: {
        fileName: _jsxFileName$4,
        lineNumber: 21,
    ...
    }, t("editTodo")), /* @__PURE__ */ React.createElement("button", {
    ...
    }, t("deleteTodo"))), /* @__PURE__ */ React.createElement(ConfirmationDialog, {
  ...
  var _jsxFileName$3 = "/home/jarancibia/git/todo-boilerplate/client/components/TodoList.jsx";
  const TodoList = ({
    todos,
    onEdit,
    onDelete
  ...
  var _jsxFileName$2 = "/home/jarancibia/git/todo-boilerplate/client/components/Notification.jsx";
  const Notification = ({
    notification,
    onClose
  }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      className: `fixed bottom-4 right-4 ${bgColor} text-white px-4 py-2 rounded shadow-lg animate__animated ${isVisible ? "animate__fadeIn" : "animate__fadeOut"}`,
      onAnimationEnd: () => {
        if (!isVisible) {
          onClose();
        }
  ...
  const useTodoFormState = (initialState = { text: "", isEditing: false, editId: null }) => {
    const [formState, setFormState] = react.exports.useState(initialState);
  ...
  const useErrorHandler = (initialError = null) => {
    const [error, setError] = react.exports.useState(initialError);
    window.setError = setError;
    const handleError = (error2) => {
      console.error(error2);
      if (error2.response) {
        if (error2.data) {
          if (typeof error2.data === "string") {
            setError(error2.data);
          } else if (error2.data.errors) {
            setError(error2.data.errors.map((e) => e.message).join(", "));
          } else {
            setError(JSON.stringify(error2.data));
          }
        } else if (error2.status === 429) {
          setError("Too many requests. Please try again later.");
        } else {
          setError(`${error2.status}: ${error2.statusText}`);
        }
  ...
  const useTodoCrud = () => {
    const [todos, setTodos] = react.exports.useState([]);
    const { error, handleError, clearError } = useErrorHandler();
  ...
  const useNotification = () => {
    const [notification, setNotification] = react.exports.useState(null);
    const [isVisible, setIsVisible] = react.exports.useState(false);
    const showNotification = react.exports.useCallback((message, type = "success", duration = 3e3) => {
    ...
    const clearNotification = react.exports.useCallback(() => {
  ...
  const ackeeServer$1 = "/ackee";
  const ackeeDomainId$1 = { "ACKEE_SERVER": "https://ackee.admin.savoietech.fr", "ACKEE_DOMAIN_ID": "c200c6bc-7a62-4f32-9975-08f5bff7f071" }.ACKEE_DOMAIN_ID;
  const useAckee = (server = ackeeServer$1, domainId = ackeeDomainId$1, options = {}) => {
    const [ackeeInstance, setAckeeInstance] = react.exports.useState(null);
    const stopRecordingRef = react.exports.useRef(null);
    react.exports.useEffect(() => {
      if (!ackeeInstance) {
        console.log("START");
        const instance = create(server, {
          detailed: true,
        ...
        return () => {
          var _a;
          if (stopRecordingRef.current && typeof ((_a = stopRecordingRef.current) == null ? void 0 : _a.stop) === "function") {
            stopRecordingRef.current.stop();
          }
        };
      }
    }, [server, domainId, options, ackeeInstance]);
    const trackEvent = react.exports.useCallback((eventId, attributes2 = {}) => {
      if (ackeeInstance) {
        ackeeInstance.action(eventId, attributes2);
      } else {
  ...
  var _jsxFileName$1 = "/home/jarancibia/git/todo-boilerplate/client/App.jsx";
  const App = () => {
    const {
      trackEvent
    } = useAckee(ackeeServer, ackeeDomainId);
    const {
      todos,
      error,
      addTodo,
    ...
    return /* @__PURE__ */ React.createElement("div", {
    ...
    }, t("title")), error, error && /* @__PURE__ */ React.createElement("div", {
      ...
      placeholder: isEditing ? t("editTodoPlaceholder") : t("newTodoPlaceholder"),
      __self: void 0,
      __source: {
        fileName: _jsxFileName$1,
        lineNumber: 86,
      ...
      type: "submit",
      className: `${isEditing ? "bg-green-500 hover:bg-green-700" : "bg-blue-500 hover:bg-blue-700"} text-white font-bold py-2 px-4 rounded-r`,
      __self: void 0,
      __source: {
        fileName: _jsxFileName$1,
        lineNumber: 95,
    ...
    }, isEditing ? t("updateTodo") : t("addTodo")))), isEditing && /* @__PURE__ */ React.createElement("button", {
    ...
    }, t("cancelEdit")), /* @__PURE__ */ React.createElement(TodoList, {
      todos,
      onEdit: startEditing,
  ...
  var _jsxFileName = "/home/jarancibia/git/todo-boilerplate/client/main.jsx";
